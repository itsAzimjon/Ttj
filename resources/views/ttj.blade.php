...
<div class="container">
      <div class="container">
        ...
        <h4 class="title">Talabalar turar joyi uchun ro‘yhatdan o‘tish</h4>
        ...
        <form action="{{ route('ttj.store')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
              <div class="mb-3">
                <label for="phone-number2" class="form-label">Ota-onaning telefon raqamni</label>
  ...
  <select class="form-select" name="region" aria-label="Default select example">
    ...
    <option value="Andijon viloyati">Andijon viloyati</option>
      ...
      <div class="row">
        ...
        <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 ">
          <select class="form-select" name="shape" aria-label="Default select example">
            <option selected  disabled>Ta'lim shakli</option>
            <option value="Davlat grand">Davlat grand</option>
            <option value="Shartnoma asosida">Shartnoma asosida</option>
      ...
      <div class="mb-3">
          <label for="oylaviy-malumot" class="form-label">Oilaviy axvolingiz haqida malumot bering</label>
          <textarea class="form-control" id="oylaviy-malumot" name="details" rows="3"></textarea>
      </div>
      <div class="mb-3">
          <label for="formFile" class="form-label">Talabalar turar joyiga joylashish uchun talabaning asoslovchi hujjati (pdf, jpg)</label>
          <input class="form-control" type="file" name="doc" id="formFile" required>
      </div>
      
      <div class="col d-none col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 ">
        <select class="form-select" name="facultate_id" aria-label="Default select example">
          <option selected disabled>Fakultet</option>
          <option value="1">Transport</option>
          <option value="2">Sanoat texnologiyalari</option>
          <option value="3">Arxitektura va qurilish</option>
          <option value="4">Energetika va radioelektronika</option>
          <option value="5">Servis</option>
          <option value="6">Qurilish materiallari va kimyoviy texnologiya</option>
        </select>
      </div>
